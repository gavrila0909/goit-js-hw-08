...
const createGalleryItems = (0, _galleryItems.galleryItems).map(({ original , preview , description  })=>`<li class="gallery__item">
...
new (0, _simplelightboxDefault.default)("ul.gallery a", {
    captionsData: "alt",
    captionDelay: 250
});
